...
<div class="container" align="center">
  ...
  <strong> Join Us Today ! Enjoy your Food :) </strong>
</div>
<br><br><br><br>
    
    <div class="container mx-5 my-5 " style="width: 400px">
      
    <?= form_open('user_login/reg');?>
...
<br>
        ...
        <?= form_submit(['name'=>'reg','value'=>'Register','class'=>'btn btn-primary']); ?>
<br>
        <?php
        if(isset($flag)){
          ?>
               ...
               <div class="alert alert-dismissible alert-warning">
                <button type="button" class="close" data-dismiss="alert">&times;</button>
                <p class="mb-0">Registration Successful</p>
                  </div>
