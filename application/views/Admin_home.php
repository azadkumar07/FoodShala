  ...
  <div class="collapse navbar-collapse" id="navbarColor02">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        ...
        <b><?= anchor('Admin_home/Add_product','Add Food'); ?></b>
      ...
      <li class="nav-item active">
        ...
        <b><?= anchor('Admin_home/Display_orders','Orders'); ?></b>
...
<div class="alert alert-dismissible alert-info">
   Click on the Orders to see the Received Orders ! Happy Cooking :)
 </div>
 <div class="container mx-5" align="right">
  <div class="container" >
    <div class="container" >
       
   <b>Search the Orders Here!</b>
