...
<br><br><br>
    ...
    <?= form_open('admin_home/insert_product');?>
    ...
    <br>
     ...
     <div class="form-group" align="left">
      ...
      <?= form_input(['name'=>'price','placeholder'=>'Enter Price', 'class'=>'form-control']); ?>
      <b><?=form_error('price');?></b>

    </div>
    <br>

    <div class="form-group" align="left">
      <label ><b>Category(Veg/Non Veg)</b></label>

      <?= form_input(['name'=>'category','placeholder'=>'Veg/Non Veg', 'class'=>'form-control']); ?>
      <b><?=form_error('category');?></b>
